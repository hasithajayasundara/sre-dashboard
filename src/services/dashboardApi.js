...
export default {
    dashboard: {
        fetchtErrorRate: payload =>
            axios
                .get(
                    `${DASHBOARD_PREFIX}${METRICS_PREFIX}/errorRate?${payload}`
                )
                .then(res => res.data),
        ...
        fetchtTotalUsers: payload =>
            axios
                .get(
                    `${DASHBOARD_PREFIX}${METRICS_PREFIX}/totalUsers${payload}`
                )
                .then(res => res.data),
        fetchtErrorBudget: payload =>
            axios
                .get(
                    `${DASHBOARD_PREFIX}${METRICS_PREFIX}/errorBudget${payload}`
                )
                .then(res => res.data),
        ...
        fetchSdkMSR: payload =>
            axios
                .get(`${DASHBOARD_PREFIX}${SDK_MSR_PREFIX}`)
                .then(res => res.data),
    },
};
